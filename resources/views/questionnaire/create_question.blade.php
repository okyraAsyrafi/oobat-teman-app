<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800">Tambah Pertanyaan Kuisioner</h2>
    </x-slot>

    <div class="py-6">
        <div class="max-w-7xl mx-auto px-4 lg:px-6">
            <div class="bg-white rounded-lg shadow p-6">
                <form method="POST" action="{{ route('questionnaire.questions.store') }}">
                    @csrf
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="question" id="question" rows="4"
                            ...
                            placeholder="Contoh: Seberapa sering Anda merasa lelah?" required>{{ old('question') }}</textarea>
                        @error('question')
                    ...
                    <div class="mb-4">
                        <label class="inline-flex items-center">
                            <input type="checkbox" name="is_active" value="1"
                                {{ old('is_active', true) ? 'checked' : '' }} class="rounded text-blue-600">
