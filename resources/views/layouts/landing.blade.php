...
<head>
    ...
    <style>
        ...
        .animate-img {
            ...
            /* scale 0.3 terlalu kecil, jadi ganti ke 0.95 agar natural */
...
<body class="bg-white font-sans text-teal-800">
    <nav id="navbar-default" class="bg-white border-gray-200 ">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="hidden w-full md:block md:w-auto" id="navbar-default">
                <ul
                    class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white  md: ">
                    <li>
                        <a href="#fitur-section"
                            class="block py-2 px-3 text-gray-900 rounded-sm hover:bg-teal-100 md:hover:bg-transparent md:border-0 md:hover:text-teal-700 md:p-0  md:dark:hover:text-teal-500   md:dark:hover:bg-transparent">Fitur</a>
                    </li>
                    <li>
                        <a href="#tb-section"
                            class="block py-2 px-3 text-gray-900 rounded-sm hover:bg-teal-100 md:hover:bg-transparent md:border-0 md:hover:text-teal-700 md:p-0  md:dark:hover:text-teal-500   md:dark:hover:bg-transparent">TB</a>
                    </li>
                    <li>
                        <a href="#education-section"
                            class="block py-2 px-3 text-gray-900 rounded-sm hover:bg-teal-100 md:hover:bg-transparent md:border-0 md:hover:text-teal-700 md:p-0  md:dark:hover:text-teal-500   md:dark:hover:bg-transparent">Edukasi</a>
                    </li>
                    <li>
                        <a href="#download-section"
                            class="block py-2 px-3 text-gray-900 rounded-sm hover:bg-teal-100 md:hover:bg-transparent md:border-0 md:hover:text-teal-700 md:p-0  md:dark:hover:text-teal-500   md:dark:hover:bg-transparent">Download</a>
                    </li>
                </ul>
            </div>
        </div>
    </nav>
    <section id="hero-section" class="bg-gradient-to-r from-teal-50 via-white to-teal-50 py-12 md:py-16">
        <div class="mx-auto grid max-w-screen-xl px-4 pb-8 md:grid-cols-12 lg:gap-12 lg:pb-16 xl:gap-0">
            <div class="content-center justify-self-start md:col-span-7 md:text-start">
                <span
                    class="bg-teal-100 text-green-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded-sm  border border-green-400">Sistem
                    Manajemen TB Terpadu</span>
                <h1
                    class="my-8 text-4xl font-extrabold leading-none tracking-tight  md:max-w-2xl md:text-5xl xl:text-6xl">
                    Kelola Pengobatan TB<br />Dengan Mudah</h1>
                <p class="mb-4 max-w-2xl text-gray-500  md:mb-12 md:text-lg mb-3 lg:mb-5 lg:text-xl">
                    ...
                    monitor
                    progress, dan edukasi kesehatan dalam satu sistem.</p>
                <button type="button"
                    class="text-white bg-teal-700 hover:bg-teal-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center me-2">
            ...
            <div class="hidden md:col-span-5 md:mt-0 md:flex">
                <img src="{{ asset('images/img-hero.png') }}" alt="gambar hero section" />
            </div>
        </div>
    </section>
    <section id="fitur-section" class="bg-white ">
            ...
            <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                ...
                <div class="max-w-sm p-8 bg-white border border-gray-200 rounded-lg shadow-sm  ">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <p class="mb-3 font-normal text-gray-500 ">
                            Pemantauan penggunaan obat dipantau langsung untuk memastikan kepatuhan pasien
        ...
        <div
            ...
            <div class="font-light text-gray-500 sm:text-lg ">
                ...
                <p class="mb-4">
                    ...
                    tuberculosis. Penyakit ini umumnya menyerang paru-paru, tetapi dapat juga menyerang organ tubuh
                    lainnya.
                </p>
                <p class="mb-4">
                ...
                <p>
                    Berjabat tangan, berbagi makanan, memakai pakaian atau peralatan yang sama dengan penderita TB.
                </p>
            </div>
        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            <div class="max-w  bg-teal-600 border border-gray-200 rounded-3xl shadow-sm  ">
                <div class="max-w-screen-md mb-8 lg:mt-8 px-4">
                    <h2 class="mb-4 text-2xl tracking-tight font-extrabold text-white ">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div class="p-6 rounded-lg">
                        <div class="flex items-center mb-4">
                            ...
                            <h3 class="text-xl font-extrabold text-white">Sembuh Total</h3>
                        </div>
                        <p class="font-light text-white text-sm leading-relaxed">
                            Pengobatan yang teratur dan konsisten dapat menyembuhkan TB hingga 95% dalam 6
                            bulan.
                        </p>
                    </div>
                    ...
                    <div class="p-6 rounded-lg">
                        <div class="flex items-center mb-4">
                            ...
                            <h3 class="text-xl font-extrabold text-white">Cegah Resistensi</h3>
                        </div>
                        <p class="font-light text-white text-sm leading-relaxed">
                    ...
                    <div class="p-6 rounded-lg">
                        <div class="flex items-center mb-4">
                            ...
                            <h3 class="text-xl font-extrabold text-white">Lindungi Orang Terdekat</h3>
                        </div>
                        <p class="font-light text-white text-sm leading-relaxed">
    ...
    <!-- Section Edukasi Terbaru -->
    <section id="education-section" class="bg-white py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        <div class="max-w-screen-md mb-8 mx-auto text-center lg:mb-16">
    ...
    <section id="download-section" class="bg-teal-700">
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
            <div class="mx-auto max-w-screen-sm">
                <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-white">
                    Mulai Management TB Sekarang
                </h2>
                <p class="mb-8 font-light text-teal-100 lg:mb-16 sm:text-xl">
    ...
    <footer class="p-4 bg-gray-800 text-white sm:p-6 ">
        <div class="mx-auto max-w-screen-xl">
            <div class="md:flex md:justify-between">
                <div class="mb-6 md:mb-0">
                    <a href="#navbar-default" class="flex items-center">
                        ...
                        <span class="self-center text-2xl font-semibold whitespace-nowrap ">Obat Teman
                            TB</span>
                    </a>
                </div>
                <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    <div>
                        ...
                        <ul class="text-gray-300 ">
                            <li class="mb-4">
                                <a href="#fitur-section" class="hover:underline">Fitur</a>
                            </li>
                            <li class="mb-4">
                                <a href="#tb-section" class="hover:underline">TB</a>
                            </li>
                            <li class="mb-4">
                                <a href="#education-section" class="hover:underline">Edukasi</a>
                            </li>
                            <li>
                                <a href="#download-section" class="hover:underline">Download</a>
                            </li>
                        </ul>
                    </div>
                    <div>
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm text-gray-400 sm:text-center ">© 2025 <a href="https://flowbite.com"
                        class="hover:underline">Obat Teman TB </a>. All Rights Reserved.
                </span>
